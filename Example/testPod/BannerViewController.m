...
@interface BannerViewController ()<FLBannerDelegate>

@property (nonatomic, strong) FLBannerManager *banner;
...
- (void)bannerBtnClicked:(UIButton*)button{
    ...
    //根据宽高比自定义适配
    CGFloat height = 60;
    self.bannerView = [[UIView alloc]initWithFrame:CGRectMake(0,FL_ScreenH-height-[UIApplication sharedApplication].keyWindow.safeAreaInsets.bottom, width, height)];
    
    self.banner =  [FLBannerManager new];
